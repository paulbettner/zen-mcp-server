...
def test_validate_token_limit_logic():
    ...
    try:
        ...
        print("  ✅ Accepted ~175k tokens (under 200k default)")
    ...
    try:
        ...
        print("  ❌ Should reject content over 200k")
    except ValueError as e:
        if "too large" in str(e):
            print("  ✅ Correctly rejected ~225k tokens")
    ...
    try:
        ...
        print("  ✅ Accepted ~750k tokens (under 800k limit)")
    except ValueError as e:
    ...
    try:
        ...
        print("  ❌ Should reject content over 800k")
    except ValueError as e:
        if "too large" in str(e):
            print("  ✅ Correctly rejected ~875k tokens")
...
def test_token_allocation_calculations():
    ...
    for total_tokens, name, expected_content_ratio, expected_file_ratio, expected_history_ratio in test_cases:
        ...
        if file_tokens < 60_000 and total_tokens > 300_000:
            print("  ⚠️ WARNING: File allocation seems artificially limited")
        elif file_tokens >= 60_000:
            print("  ✅ File allocation > 60k tokens - no artificial limit")
